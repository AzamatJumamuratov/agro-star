...
const NewsItem = ({ id, image, title, content, date, additionalClass }) => {
  ...
  return (
    <article
      ...
      className={` rounded-2xl border border-[#727272] group hover:border-l-8 hover:border-b-8 hover:border-primary bg-[#F8F9FA] hover:cursor-pointer ${
        additionalClass ? additionalClass : ""
      }`}
    >
      {image && <img src={image} className="w-full mb-4 rounded-t-2xl" />}
      <div className="px-5 xl:pb-24 lg:pb-9 md:pb-9 pb-5 mt-6">
        {!image && (
          <div className="mb-4">
