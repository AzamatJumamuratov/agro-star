...
const NewsItem = ({ title, content, date }) => {
  ...
  return (
    <article className="lg:pt-6 md:pt-4 pt-3 px-5 xl:pb-24 lg:pb-16 md:pb-9 pb-5 rounded-2xl border border-[#727272] group hover:border-l-8 hover:border-b-8 hover:border-primary bg-[#F8F9FA] hover:cursor-pointer">
      <div className="mb-4">
